"""
From labmlai implementation of DDPM:
- UNet for \epsilon_\theta
- Trainer:
    - loss function
...
# =========================
"""
From labmlai implementation: annotated_deep_learning_paper_implementations/labml_nn/diffusion/ddpm/unet.py
---
...
class DenoiseDiffusion:
    ...
    From labmlai::annotated_deep_learning_paper_implementations/labml_nn/diffusion/ddpm/__init__.py
    """
    def __init__(self, eps_model: torch.nn.Module, n_steps: int, device: torch.device):
        """
        ...
        * `device` is the device to place constants on
        ...
        T = n_steps
        self.alpha = (1- 0.02*torch.linspace(1,T,T)/T).to(device)
...
def p_sample(xt: torch.Tensor, t: torch.Tensor,*, eps_model, alpha_bar, alpha, sigma2 ):
    """
    #### Sample from $\textcolor{lightgreen}{p_\theta}(x_{t-1}|x_t)$
    ...
    where :
    * `eps_model`: Callable(x_t,t)-->score function
    """
